...
INPUT_DIR = os.path.abspath(os.path.join(REPO_ROOT_DIR, "/input")) # Change these back to /input and /output before turning it in
OUTPUT_DIR = os.path.abspath(os.path.join(REPO_ROOT_DIR, "/output"))
