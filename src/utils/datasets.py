...
def load_datasets(
        ...
        val_set_size: Optional[float] = 0.2, test_set_size: Optional[float] = 0.2, seed: Optional[int] = 42,
        is_multi: Optional[bool] = False) -> [Dataset, Dataset, Dataset]:
    """
    ...
    Args:
        ...
        is_multiclass (Optinal[bool]): Flag used to determine if dataset is for binary classification or multiclass.
...
if __name__ == '__main__':
    ...
    train_ds, val_ds, test_ds = load_datasets(
        color_mode='rgb', target_size=(64, 64), interpolation='bilinear', keep_aspect_ratio=False, num_partitions=1,
        batch_size=32, num_images=None, train_set_size=0.6, val_set_size=0.2, test_set_size=0.2, seed=42, is_multi=False
    )
